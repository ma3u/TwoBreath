...
| --- | --- | --- | --- | --- | --- |
| [O.Purp_1](regulations/markdown/BSI-TR-03161-1.md#o-purp-1) | Informationspflicht des Herstellers | CHECK | M + D | ✅ | APPLIED in TwoBreath-app commit [b73419a](https://github.com/ma3u/TwoBreath-app/commit/b73419a) (Patch §5): SecurityInfoView angelegt. Originalbewertung: App-Store-Beschreibung + Info.plist + In-App-Erstinformations-Bildschirm (Patch § 5) + Datenschutzkonzept (concepts/01-datenschutzkonzept.md). PrivacyInfo.xcprivacy maschinenlesbar. |
...
| [O.Purp_3](regulations/markdown/BSI-TR-03161-1.md#o-purp-3) | Einholung einer | CHECK | M + D | ✅ | APPLIED in TwoBreath-app commit [17ab902](https://github.com/ma3u/TwoBreath-app/commit/17ab902) (Patch §9): ConsentLog/Tracker/View — Erstinformations-UI in §5 (b73419a). Originalbewertung: iOS-vermittelte System-Dialoge plus In-App-Erstinformations-Texte (Patch § 5). Tatsache der Einwilligung wird per ConsentTracker (Patch § 9) protokolliert. |
...
| [O.Purp_5](regulations/markdown/BSI-TR-03161-1.md#o-purp-5) | Entzug der Einwilligung | CHECK | M + D | ✅ | APPLIED in TwoBreath-app commit [7b9ca59](https://github.com/ma3u/TwoBreath-app/commit/7b9ca59) (Patch §7): DataEraseService + In-App-Löschen-Dialog (UI in §5). Originalbewertung: iOS-Einstellungen + In-App-Pairing-Aufhebung + In-App-Alle-Daten-löschen (Patch § 7). Konsequenz-Hinweise im SecurityInfoView (Patch § 5) und Confirmation-Dialog. ConsentTracker erfasst Widerrufe (Patch § 9, source=iosSettingsRevoke / inAppRevoke). |
| [O.Purp_6](regulations/markdown/BSI-TR-03161-1.md#o-purp-6) | Führen eines Verzeichnisses der | CHECK | M + D | ✅ | APPLIED in TwoBreath-app commit [17ab902](https://github.com/ma3u/TwoBreath-app/commit/17ab902) (Patch §9): ConsentLog SwiftData-Modell + ConsentTracker + ConsentLogView. Originalbewertung: ConsentTracker + ConsentLog SwiftData-Modell (Patch § 9, Konzept concepts/05-einwilligungsverzeichnis.md). In-App-Verlaufsanzeige + JSON-Export. Verzeichnis bleibt lokal, vollständig nutzer-einsehbar. |
...
| [O.Source_3](regulations/markdown/BSI-TR-03161-1.md#o-source-3) | Keine sensiblen Daten in Meldungen. | CHECK | D | ✅ | APPLIED in TwoBreath-app commit [e463e68](https://github.com/ma3u/TwoBreath-app/commit/e463e68) (Patch §10): SwiftLint Custom-Rule `os_log_privacy_marker` aktiv. Originalbewertung: Secure-Coding-Standards § 2 erzwingt privacy-Marker bei jeder os.Logger-Interpolation. SwiftLint-Custom-Regel `os_log_privacy_marker` (Patch § 10) blockt Verstöße in CI. `print(...)` in Produktiv-Pfaden verboten. |
...
| [O.Source_9](regulations/markdown/BSI-TR-03161-1.md#o-source-9) | Aktivierung von modernen | CHECK | D | ✅ | APPLIED in TwoBreath-app commit [f699bc5](https://github.com/ma3u/TwoBreath-app/commit/f699bc5) (Patch §8): Release-Hardening in project.yml: STRIP_*, DEAD_CODE_STRIPPING, -Wl,-x. Originalbewertung: Apple-Toolchain-Defaults aktiv. Symbol-Stripping in Release-Konfiguration explizit gesetzt (Patch § 8: STRIP_INSTALLED_PRODUCT, STRIP_SWIFT_SYMBOLS, DEAD_CODE_STRIPPING). |
...
| [O.Data_10](regulations/markdown/BSI-TR-03161-1.md#o-data-10) | Keine Aufzeichnungen bei der | EXAMINE | D | ✅ | APPLIED in TwoBreath-app commit [c6557e0](https://github.com/ma3u/TwoBreath-app/commit/c6557e0) (Patch §3): Pairing-Code-TextField mit .textContentType(.oneTimeCode) + .privacySensitive(). Originalbewertung: Pairing-Code-Eingabe mit `.textContentType(.oneTimeCode)` + `.privacySensitive()` + `.autocorrectionDisabled()` (Patch § 3). |
| [O.Data_11](regulations/markdown/BSI-TR-03161-1.md#o-data-11) | Kein Export sensibler Daten in | CHECK | D | ✅ | APPLIED in TwoBreath-app commit [f1ece0b](https://github.com/ma3u/TwoBreath-app/commit/f1ece0b) (Patch §4): .textSelection(.disabled) auf DashboardView-Wurzel. Originalbewertung: Sensible Anzeigen mit `.textSelection(.disabled)` und `.privacySensitive()` markiert (Patch § 4). |
...
| [O.Data_13](regulations/markdown/BSI-TR-03161-1.md#o-data-13) | Keine Speicherung des | CHECK | D | ✅ | APPLIED in TwoBreath-app commit [8f22f75](https://github.com/ma3u/TwoBreath-app/commit/8f22f75) (Patch §2): AppSwitcherShield-ViewModifier auf DashboardView. Originalbewertung: AppSwitcherShield-ViewModifier (Patch § 2) verdeckt sensible Anzeigen bei Übergang in den Hintergrund. Anwendung auf alle HealthKit-anzeigenden Views. |
...
| [O.Data_17](regulations/markdown/BSI-TR-03161-1.md#o-data-17) | Möglichkeit zum Löschen oder | EXAMINE | D | ✅ | APPLIED in TwoBreath-app commit [7b9ca59](https://github.com/ma3u/TwoBreath-app/commit/7b9ca59) (Patch §7): DataEraseService.eraseAllLocalData(modelContext:) — Confirmation-Dialog in §5. Originalbewertung: DataEraseService + Settings-UI mit Confirmation-Dialog (Patch § 7) löscht SessionLog, ConsentLog, PartnerPairing und entfernt App-eigene HealthKit-Mindful-Minutes. |
...
| ID | Kurzfassung (TR-03161-1 § 4.3) | Prüftiefe | Class | TwoBreath | Begründung / Quelle |
| --- | --- | --- | --- | --- | --- |
| [O.Plat_1](regulations/markdown/BSI-TR-03161-1.md#o-plat-1) | Geräteschutz für die Nutzung der | CHECK | M | ✅ | APPLIED in TwoBreath-app commit [b73419a](https://github.com/ma3u/TwoBreath-app/commit/b73419a) (Patch §5): Sicherheits-Empfehlungen in SecurityInfoView (Geräte-PIN, Pairing-Vertrauen, …). Originalbewertung: Sicherheits-Empfehlungs-Bildschirm (Patch § 5) klärt explizit über Geräte-Sperre / Face-/Touch-ID auf — Erstes Bullet im SecurityInfoView. |
...
| [O.Plat_9](regulations/markdown/BSI-TR-03161-1.md#o-plat-9) | Entfernung von sensiblen Daten bei | EXAMINE | D | ✅ | APPLIED in TwoBreath-app commit [8f22f75](https://github.com/ma3u/TwoBreath-app/commit/8f22f75) (Patch §2): AppSwitcherShield maskiert Hintergrund-Snapshot. Originalbewertung: AppSwitcherShield-ViewModifier (Patch § 2) maskiert sensible Inhalte bei Übergang in den Hintergrund. |
...
| [O.Plat_13](regulations/markdown/BSI-TR-03161-1.md#o-plat-13) | Information des Nutzers über | CHECK | M | ✅ | APPLIED in TwoBreath-app commit [b73419a](https://github.com/ma3u/TwoBreath-app/commit/b73419a) (Patch §5): SecurityInfoView mit Sicherheits-Bullets + Verarbeitungs-Übersicht. Originalbewertung: SecurityInfoView (Patch § 5) im Settings-Bildschirm enthält Sicherheits-Empfehlungen, Verarbeitungs-Übersicht, Verlauf-Verlinkung, Vulnerability-Disclosure-Link. |
...
| ID | Kurzfassung (TR-03161-1 § 4.3) | Prüftiefe | Class | TwoBreath | Begründung / Quelle |
| --- | --- | --- | --- | --- | --- |
| [O.Resi_1](regulations/markdown/BSI-TR-03161-1.md#o-resi-1) | Informationen zum sicheren | CHECK | M | ✅ | APPLIED in TwoBreath-app commit [b73419a](https://github.com/ma3u/TwoBreath-app/commit/b73419a) (Patch §5): Best-Practice-Empfehlungen-Sektion in SecurityInfoView. Originalbewertung: Best-Practice-Empfehlungen im SecurityInfoView (Patch § 5) — gleicher Bildschirm wie O.Plat_13. |
...
| [O.Resi_3](regulations/markdown/BSI-TR-03161-1.md#o-resi-3) | Erkennung und Unterbindung des | CHECK | D | ✅ | APPLIED in TwoBreath-app commit [7ecd9da](https://github.com/ma3u/TwoBreath-app/commit/7ecd9da) (Patch §1): assertNotDebugged() in TwoBreath/App/DebugDetection.swift, Aufruf aus TwoBreathApp.init(). Originalbewertung: `assertNotDebugged()`-Funktion via `sysctl(KERN_PROC, …, P_TRACED)` (Patch § 1), aufgerufen in App-Init. Wirkt nur in Release-Builds. |
...
| [O.Resi_8](regulations/markdown/BSI-TR-03161-1.md#o-resi-8) | Umsetzung von Maßnahmen gegen | EXAMINE | D | ✅ | APPLIED in TwoBreath-app commit [f699bc5](https://github.com/ma3u/TwoBreath-app/commit/f699bc5) (Patch §8): Release-Symbol-Stripping aktiv (zusammen mit Apple-Toolchain-Defaults Stack-Canary/ASLR/NX). Originalbewertung: Apple-Toolchain-Defaults + scharf gesetztes Symbol-Stripping in Release (Patch § 8). Trade-off-Begründung gegen kommerzielle Obfuscation in concepts/08-resilienz-haertungskonzept.md § 8 dokumentiert. |
